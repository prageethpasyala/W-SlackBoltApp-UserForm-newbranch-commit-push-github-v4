...
def handle_insert(record):
	...
	newCIDR = newImage['cidr']['S']
	newWhiteList = newImage['whitelist']['S']
	newVPC = newImage['vpcname']['S']
	newRegion = newImage['region']['S']

	#3c. Print it
	print ('New row added with CIDR = ' + newCIDR)
	print ('New row added with Whitelist = ' + newWhiteList)
	print ('New row added with VPC = ' + newVPC)
	print ('New row added with Region = ' + newRegion)
